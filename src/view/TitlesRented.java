...
public class TitlesRented extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("Movie")) {
			...
			// Gathering the data
			data = jdbc.titleRentedmusiclive();
			...
			// Gathering the data
			data = jdbc.titleRentedliveconcert();
